...
export const HEXAGRAMS: Record<string, HexagramInfo> = {
  ...
  "010111": { name: "水天需", pinyin: "Xū", symbol: "䷄", meaning: "守正待时", description: "中。云在天上，待雨而下。宜耐心等待，做好准备。" },
  "111010": { name: "天水讼", pinyin: "Sòng", symbol: "䷅", meaning: "慎争戒讼", description: "凶。意见不合，易生口舌。宜退避三舍，和为贵。" },
  ...
  "011010": { name: "泽水困", pinyin: "Kùn", symbol: "䷮", meaning: "穷困潦倒", description: "凶。泽中无水，孤立无援。宜忍耐坚持，修身养性。" },
  ...
  "010111": { name: "水泽节", pinyin: "Jié", symbol: "䷻", meaning: "节制有度", description: "中。泽水有限，需有节约。宜开源节流，适可而止。" },
